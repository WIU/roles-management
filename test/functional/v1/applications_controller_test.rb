...
class Api::V1::ApplicationsControllerTest < ActionController::TestCase
  test "JSON index request should include certain attributes" do
    ...
    #ensure_test_user_has_admin_access api users have admin access by design
  ...
  test "JSON index request should be unavailable without any access" do
    revoke_all_access
  ...
  test "JSON show request should not include inactive entities" do
    ...
    get :show, :format => :json, :id => inactiveEntity.application_ownerships[0].application_id
